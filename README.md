...
==================================================================================================================================================
 ...
 Project Overview
The Care Home Management System is a MySQL database project designed to manage the data of the Residents, Admissions, Rooms and caregivers of a Care Home.
...
---
 ...
 Relationships
- each resident can have one admission.
- each room can have many admissions.
- each caregiver can manage many rooms.
